        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-3 text-center text-md-left mb-3 mb-md-0">
                    <img src="{{'assets/frontend/imgs/logo.svg'}}" alt="" class="logo">
                </div>
            ...
            <p class="border-top mb-0 mt-4 pt-3 small">&copy; <script>document.write(new Date().getFullYear())</script>, WorldBlog Created By <a href="#" class="text-muted font-weight-bold" target="_blank">FaisalImam.</a>  All rights reserved </p> 
        </div>      
    </footer>
    <!-- End of Page Footer -->

	<!-- core  -->
    <script src="{{'assets/frontend/vendors/jquery/jquery-3.4.1.js'}}"></script>
    <script src="{{'assets/frontend/vendors/bootstrap/bootstrap.bundle.js'}}"></script>

    <!-- JoeBLog js -->
    <script src="{{'assets/frontend/js/joeblog.js'}}"></script>